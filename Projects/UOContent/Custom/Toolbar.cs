		...
		public static List<string> DefaultEntries( int i )
		{
			...
			switch(i)
			{
				...
				case 2: // GameMaster
					...
					entries.Add("Get Hue"); entries.Add("Move"); entries.Add("M Remove"); entries.Add("Wipe"); entries.Add("Props"); entries.Add("Get Location"); entries.Add("Get ItemID"); entries.Add("AddStairs"); for( int j = 0; j < 1; j++ ){entries.Add("-");}
					entries.Add("AddDoor"); entries.Add("ViewEquip"); entries.Add("Skills"); entries.Add("Kick"); entries.Add("Kill");
					break;
				case 3: // Seer
					goto case 2;
				case 4: // Administrator
					entries.Add("Admin"); entries.Add("GMBody"); entries.Add("StaffRunebook"); entries.Add("GM"); entries.Add("M Tele"); entries.Add("Where"); entries.Add("Who"); entries.Add("Self Hide"); for( int j = 0; j < 1; j++ ){entries.Add("-");}
					entries.Add("Save"); entries.Add("Skills"); entries.Add("Move"); entries.Add("M Remove"); entries.Add("Wipe"); entries.Add("Props"); entries.Add("Recover"); entries.Add("Self Unhide"); for( int j = 0; j < 1; j++ ){entries.Add("-");}
					entries.Add("Get Hue"); entries.Add("Get Location"); entries.Add("Get ItemID"); entries.Add("AddDoor"); entries.Add("AddStairs"); entries.Add("Speedboost"); entries.Add("Invul"); entries.Add("NoInvul"); for( int j = 0; j < 1; j++ ){entries.Add("-");}
					break;
				case 5: // Developer
					goto case 4;
				case 6: // Owner
