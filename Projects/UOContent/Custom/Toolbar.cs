...
namespace Joeku
{
    public class ToolbarHelper
    {
        ...
        public static void Initialize()
        {
            ...
            CommandSystem.Register("Toolbar", AccessLevel.Counselor, new CommandEventHandler(Toolbar_OnCommand));
            ...
            /* if (Enabled)
            {
               ...
               Console.Write("Joeku's Toolbar: Loading...");
               Console.ForegroundColor = ConsoleColor.Green;
               Console.Write("done ");
               Console.WriteLine("( ***Joeku's Toolbar Activated*** )");
               Console.ResetColor();
            }
            else
            {
        ...
        public static void OnPlayerDeath(Mobile mobile)
        {
            if (mobile.AccessLevel >= AccessLevel.Counselor)
            {
                mobile.CloseGump<Toolbar>();
                object[] arg = new object[] { mobile };
                Timer.DelayCall(TimeSpan.FromSeconds(2.0), () => SendToolbar(arg));
            }
        }
        ...
        /// </summary>
        private static void OnLogin(Mobile mobile)
        {
            if (mobile.AccessLevel >= AccessLevel.Counselor)
            {
                mobile.CloseGump<Toolbar>();
    ...
    public class ToolbarInfo
    {
        ...
        public ToolbarInfo(
            string account, List<int> dimensions, List<string> entries, int skin, List<Point3D> points, int font,
            bool[] switches
        )
        {
        ...
        public static List<string> DefaultEntries(int i)
        {
            ...
            switch (i)
            {
                ...
                case 1: // Counselor
                    ...
                    entries.Add("Where");
                    entries.Add("Who");
                    entries.Add("Self Hide");
                    entries.Add("Self Unhide");
                    break;
                case 2: // GameMaster
                    entries.Add("GMBody");
                    entries.Add("StaffRunebook");
                    ...
                    entries.Add("Get Hue");
                    entries.Add("Move");
                    entries.Add("M Remove");
                    entries.Add("Wipe");
                    entries.Add("Props");
                    entries.Add("Get Location");
                    entries.Add("Get ItemID");
                    entries.Add("AddStairs");
                    for (int j = 0; j < 1; j++)
                    {
                        entries.Add("-");
                    }
    ...
    public class Toolbar : Gump
    {
        ...
        *******************/
        ...
        {
            InitOptsW = 50 + (offset * 2) + GumpIDs.Buttons[(int)GumpIDs.ButtonIDs.Minimize].Content[p_Skin, 2] + 5 +
    ...
    public class ToolbarEdit : Gump
    {
        ...
        public ToolbarEdit(
            ToolbarInfo info, List<string> commands, int skin, int columns, int rows, int font, bool[] switches
        ) : this(info, false, commands, skin, columns, rows, font, switches)
        {
        }

        public ToolbarEdit(
            ToolbarInfo info, bool expanded, List<string> commands, int skin, int columns, int rows, int font,
            bool[] switches
        ) : base(0, 28)
        {
            p_Info = info;
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            switch (info.ButtonID)
            {
                ...
                case 1:
                    m.SendGump(
                        new ToolbarEdit(p_Info, this.p_Expanded, AnalyzeEntries(), Skin + 1, Columns, Rows, Font, switches)
                    );
                    break;
                case 2:
                    m.SendGump(
                ...
                case 3:
                    m.SendGump(
                        new ToolbarEdit(p_Info, this.p_Expanded, AnalyzeEntries(), Skin, Columns, Rows + 1, Font, switches)
                    );
                    break;
                case 4:
                    m.SendGump(
                ...
                case 5:
                    m.SendGump(
                        new ToolbarEdit(p_Info, this.p_Expanded, AnalyzeEntries(), Skin, Columns + 1, Rows, Font, switches)
                    );
                    break;
                case 6:
                    m.SendGump(
                ...
                case 18:
                    m.SendGump(
                        new ToolbarEdit(p_Info, this.p_Expanded, AnalyzeEntries(), Skin, Columns, Rows, Font + 1, switches)
                    );
                    break;
                case 19:
                    m.SendGump(
                ...
                case 20:
                    m.SendGump(
                        new ToolbarEdit(p_Info, this.p_Expanded, AnalyzeEntries(), Skin, Columns, Rows, Font, switches)
                    );
    ...
    public class GumpIDs
    {
        ...
        {
            "", "<b>", "<i>", "<b><i>", "<small>", "<b><small>", "<i><small>", "<b><i><small>", "<big>", "<b><big>",
            "<i><big>", "<b><i><big>"
        };
